...
type ProjectInitParameters struct {
	...
	// (Boolean) Set whether or not a pipeline triggerer is allowed to approve deployments. Premium and Ultimate only.
	// Set whether or not a pipeline triggerer is allowed to approve deployments. Premium and Ultimate only.
	AllowPipelineTriggerApproveDeployment *bool `json:"allowPipelineTriggerApproveDeployment,omitempty" tf:"allow_pipeline_trigger_approve_deployment,omitempty"`
	...
	// (Number) Pipelines older than the configured time are deleted.
	// Pipelines older than the configured time are deleted.
	CiDeletePipelinesInSeconds *float64 `json:"ciDeletePipelinesInSeconds,omitempty" tf:"ci_delete_pipelines_in_seconds,omitempty"`
	...
	// (List of String) Fields included in the sub claim of the ID Token. Accepts an array starting with project_path. The array might also include ref_type and ref. Defaults to ["project_path", "ref_type", "ref"]. Introduced in GitLab 17.10.
	...
	CiIDTokenSubClaimComponents []*string `json:"ciIdTokenSubClaimComponents,omitempty" tf:"ci_id_token_sub_claim_components,omitempty"`

	// (String) The minimum role required to set variables when running pipelines and jobs. Introduced in GitLab 17.1. Valid values are developer, maintainer, owner, no_one_allowed
	...
	CiPipelineVariablesMinimumOverrideRole *string `json:"ciPipelineVariablesMinimumOverrideRole,omitempty" tf:"ci_pipeline_variables_minimum_override_role,omitempty"`

	// (String) The role required to cancel a pipeline or job. Premium and Ultimate only. Valid values are developer, maintainer, no one
	...
	// (String) Template used to create merge commit message in merge requests.
	...
	// (String) Set visibility of machine learning model experiments. Valid values are disabled, private, enabled.
	// Set visibility of machine learning model experiments. Valid values are `disabled`, `private`, `enabled`.
	ModelExperimentsAccessLevel *string `json:"modelExperimentsAccessLevel,omitempty" tf:"model_experiments_access_level,omitempty"`

	// (String) Set visibility of machine learning model registry. Valid values are disabled, private, enabled.
	// Set visibility of machine learning model registry. Valid values are `disabled`, `private`, `enabled`.
	ModelRegistryAccessLevel *string `json:"modelRegistryAccessLevel,omitempty" tf:"model_registry_access_level,omitempty"`
	...
	// (Boolean) Set to true to immediately permanently delete the project instead of scheduling a delete for Premium and Ultimate tiers.
	// Set to `true` to immediately permanently delete the project instead of scheduling a delete for Premium and Ultimate tiers.
	PermanentlyDeleteOnDestroy *bool `json:"permanentlyDeleteOnDestroy,omitempty" tf:"permanently_delete_on_destroy,omitempty"`
	...
	// (Boolean) Whether Secret Push Detection is enabled. Requires GitLab Ultimate and at least GitLab 17.3.
	// Whether Secret Push Detection is enabled. Requires GitLab Ultimate and at least GitLab 17.3.
	PreReceiveSecretDetectionEnabled *bool `json:"preReceiveSecretDetectionEnabled,omitempty" tf:"pre_receive_secret_detection_enabled,omitempty"`

	// (Boolean) Set whether merge requests require an associated issue from Jira. Premium and Ultimate only.
	// Set whether merge requests require an associated issue from Jira. Premium and Ultimate only.
	PreventMergeWithoutJiraIssue *bool `json:"preventMergeWithoutJiraIssue,omitempty" tf:"prevent_merge_without_jira_issue,omitempty"`
	...
	PushRules []ProjectPushRulesInitParameters `json:"pushRules,omitempty" tf:"push_rules,omitempty"`
	...
	// (String) Template used to create squash commit message in merge requests.
	// Template used to create squash commit message in merge requests.
	SquashCommitTemplate *string `json:"squashCommitTemplate,omitempty" tf:"squash_commit_template,omitempty"`

	// (String) Squash commits when merge request is merged. Valid values are never (Do not allow), always (Require), default_on (Encourage), or default_off (Allow). The default value is default_off (Allow).
...
type ProjectObservation struct {
	...
	// (Block List, Max: 1) Push rules for the project. (see below for nested schema)
	// Push rules for the project.
	PushRules []ProjectPushRulesObservation `json:"pushRules,omitempty" tf:"push_rules,omitempty"`
...
type ProjectParameters struct {
	...
	// Push rules for the project.
	// +kubebuilder:validation:Optional
	PushRules []ProjectPushRulesParameters `json:"pushRules,omitempty" tf:"push_rules,omitempty"`
...
type ProjectPushRulesInitParameters struct {
...
type ProjectPushRulesObservation struct {
...
type ProjectPushRulesParameters struct {
